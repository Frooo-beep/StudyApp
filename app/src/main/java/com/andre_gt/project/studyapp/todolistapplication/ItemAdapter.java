...
public class ItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        RelativeLayout clickCardView = convertView.findViewById(R.id.keactivitydetail);
        ...
        clickCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String judul = titleTextView.getText().toString();
                String tanggal = dateTextView.getText().toString();
                String waktu = timeTextView.getText().toString();

                Intent intent = new Intent(context, ActivityDetailTodo.class);
