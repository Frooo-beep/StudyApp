...
public class TodoActivity extends AppCompatActivity {
    ...
    private com.coolcode.project.studyapp.todo.DatabaseHelper databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper = new com.coolcode.project.studyapp.todo.DatabaseHelper(this);
    ...
    private Notification getNotification(String content) {
        ...
        builder.setContentTitle("Study Up!");
...
//        notificationManagerCompat.notify(notification, builder.build);
    ...
    private void populateListView() {
        try {
            ArrayList<com.coolcode.project.studyapp.todo.ModelData> items = databaseHelper.getAllData();
            com.coolcode.project.studyapp.todo.ItemAdapter itemsAdopter = new com.coolcode.project.studyapp.todo.ItemAdapter(this, items);
