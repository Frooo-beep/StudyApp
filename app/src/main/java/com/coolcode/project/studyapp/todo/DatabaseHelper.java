...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<com.coolcode.project.studyapp.todo.ModelData> getAllData() {
        ArrayList<com.coolcode.project.studyapp.todo.ModelData> arrayList = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            com.coolcode.project.studyapp.todo.ModelData modelData = new com.coolcode.project.studyapp.todo.ModelData(id, title, date, time);
